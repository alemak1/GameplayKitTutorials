...
class GKSpikemanBottom: GKEnemy{
    ...
    init(scalingFactor: CGFloat, position: CGPoint?, movementLowerBound: CGFloat?, movementUpperBound: CGFloat?) {
        ...
        let randomBottomEdgePoint = RandomGenerator.getRandomEdgePointFor(screenEdge: .Bottom)
        let spikeManPos = position ?? randomBottomEdgePoint
        ...
        let moveAction1: SKAction = (movementUpperBound == nil) ?
            SKAction.move(to: ScreenPoints.BottomRightCorner, duration: 2.00) :
            SKAction.move(to: CGPoint(x: movementUpperBound!, y: ScreenPoints.BottomRightCorner.y ), duration: 2.00)
        
        let moveAction2: SKAction = (movementLowerBound == nil) ?
            SKAction.move(to: ScreenPoints.BottomLeftCorner, duration: 2.00) :
            SKAction.move(to: CGPoint(x: movementLowerBound! , y: ScreenPoints.BottomRightCorner.y), duration: 2.00)
